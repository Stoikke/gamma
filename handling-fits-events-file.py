...
fitsfile='data/Photon_projet/lat_photon_weekly_all.fits'    # put here the path to your favorite file
...
emin_mask = energy > 5000 # ne garde que les evenements dont l'energie est sup à 100 MeV
tot_mask = emin_mask & zenith_angle_mask #& emin_mask  # les 2 masques a la fois
...
# this is to fill and plot a 2D histogram
counts1, xedges1, yedges1, im1 = axs[1].hist2d(l_cut,b_cut,bins=[500,500],norm=LogNorm())
#counts1, xedges1, yedges1, im1 = axs[1].hist2d(l,b,bins=[360,180])
fig.colorbar(im1,ax=axs[1])

# this is to display a scatter plot
#axs[1].scatter(l,b,marker='o',s=0.0001)
axs[1].set_xlim(258,267.5)
axs[1].set_ylim(-5,0)
plt.show()
#plt.hist(zenith_angle)
#plt.show()
exit(0)
