...
PEAK_TIME_CONSTRAINTS = [
    (5.034026e+08, 5.033304e+08, 5.034909e+08),   # Peak 1
    (5.035561e+08, 5.034482e+08, 5.036444e+08),   # Peak 2
]
...
plt.savefig("light_curve_fit_6h_MC.png", dpi=150, bbox_inches="tight")
plt.show()
